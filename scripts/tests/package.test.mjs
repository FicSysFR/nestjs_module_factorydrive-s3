...
test('parsePackOutput supports npm 11 and npm 12 reports', () => {
  const report = { name: '@ficsysfr/nestjs_module_factorydrive-s3', version: '2.0.0' }
...
test('validateSatelliteManifest enforces identity, SemVer, and core major', () => {
  assert.doesNotThrow(() =>
    validateSatelliteManifest({
      ...
      version: '2.0.0',
      repository: 'https://github.com/FicSysFR/nestjs_module_factorydrive-s3.git',
      homepage: 'https://ficsysfr.github.io/nestjs_module_factorydrive/guide/drivers',
      bugs: { url: 'https://github.com/FicSysFR/nestjs_module_factorydrive-s3/issues' },
  ...
  assert.throws(
    () =>
      validateSatelliteManifest({
        name: '@ficsysfr/nestjs_module_factorydrive-s3',
        version: '2.0.0',
        repository: 'https://github.com/tacxou/nestjs_module_factorydrive-s3.git',
        homepage: 'https://ficsysfr.github.io/nestjs_module_factorydrive/guide/drivers',
        bugs: { url: 'https://github.com/FicSysFR/nestjs_module_factorydrive-s3/issues' },
        publishConfig: { access: 'public', registry: 'https://registry.npmjs.org/' },
        peerDependencies: { '@ficsysfr/nestjs_module_factorydrive': '^2.0.0' },
